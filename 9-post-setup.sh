...
# ------------------------------------------------------------------------
# extra packages
sudo pacman -S mtools dosfstools networkmanager  nvidia nvidia-utils zsh firefox base-devel linux-headers screenfetch xdg-utils xdg-user-dirs packagekit-qt5 --noconfirm --needed
yay -S --noconfirm timeshift ttf-roboto polkit materia-gtk-theme lxsession pnmixer wget qt5-styleplugins unzip
#installing awesome package manager theme
